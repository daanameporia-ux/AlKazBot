...
- **Strict scope.** Делать ровно ту задачу, что поставлена. Не
  добавлять «бонус-разделов», воронок, рекомендаций «что дальше»,
  USDT-конвертаций, разбивок по партнёрам и прочих секций, которых
  не просили. Просят список — давать список. Просят число — давать
  число. Применимо и к коду-режиму (Claude/Codex), и к боту в чате.
  Источник: инцидент 2026-05-01 (на «дай общий список» агент выкатил
  4 секции с расчётами).
