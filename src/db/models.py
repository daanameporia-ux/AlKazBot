...
class MessageLog(Base):
    ...
    media_file_unique_id: Mapped[str | None] = mapped_column(Text)
    media_file_name: Mapped[str | None] = mapped_column(Text)
    media_mime_type: Mapped[str | None] = mapped_column(Text)
    media_file_size: Mapped[int | None] = mapped_column(Integer)
